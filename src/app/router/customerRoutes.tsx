...
const EditAnamnesisPage = React.lazy(() => import("@/pages/anamnesis/EditAnamnesisPage"));
...
export const CustomerRoutes = (
  <Route path={ROUTES.CUSTOMERS.BASE}>
    ...
    <Route path=":customerId/create-anamnesis" element={
      <RequireAuthLayout allowedRoles={["PROFESSIONAL", "SECRETARY", "ADMIN"]}>
        <Suspense fallback={<LoadingFallback />}>
          <NewAnamnesisPage />
        </Suspense>
    ...
    <Route path=":customerId/edit-anamnesis/:anamnesisId" element={
      <RequireAuthLayout allowedRoles={["PROFESSIONAL", "SECRETARY", "ADMIN"]}>
        <Suspense fallback={<LoadingFallback />}>
          <EditAnamnesisPage />
        </Suspense>
    ...
    <Route path=":customerId/consultas/create" element={
      <RequireAuthLayout allowedRoles={["PROFESSIONAL", "SECRETARY", "ADMIN"]}>
        <Suspense fallback={<LoadingFallback />}>
          <ConsultaProvider>
            <NewConsultaPage />
    ...
    <Route path=":customerId/consultas/:consultaId/*" element={
      <RequireAuthLayout allowedRoles={["PROFESSIONAL", "SECRETARY", "ADMIN"]}>
        <Suspense fallback={<LoadingFallback />}>
          <ConsultaDetailsPage />
        </Suspense>
