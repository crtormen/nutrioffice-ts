...
const EditAnamnesisPage = () => {
  ...
  const [updateAnamnesis, { isLoading: isSaving }] = useUpdateAnamnesisMutation();
  ...
  const breadcrumbs = [
    ...
    {
      label: "Anamnese",
      href: customerId ? `/${ROUTES.CUSTOMERS.DETAILS(customerId)}/anamnesis` : undefined,
    },
    { label: "Editar" },
  ];
  ...
  return (
    <div className="space-y-6 p-6 md:p-10">
      <PageHeader
        ...
        backTo={customerId ? `/${ROUTES.CUSTOMERS.DETAILS(customerId)}/anamnesis` : undefined}
      />
      ...
      <div className="max-w-4xl space-y-8">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Editar Anamnese</h2>
          </div>
              ...
              <>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    onClick={() => navigate(`/${ROUTES.CUSTOMERS.DETAILS(customerId!)}/anamnesis`)}
                  >
                    Cancelar
                  </Button>
                </div>
